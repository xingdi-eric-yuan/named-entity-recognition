...
void
gradientChecking_ConvLayer(std::vector<Cvl> &CLayers, std::vector<Fcl> &hLayers, Smr &smr, std::vector<Mat> &x, Mat &y){
...
void
gradientChecking_FullConnectLayer(std::vector<Cvl> &CLayers, std::vector<Fcl> &hLayers, Smr &smr, std::vector<Mat> &x, Mat &y){
    //Gradient Checking (remember to disable this part after you're sure the 
    //cost function and dJ function are correct)
...
void
gradientChecking_SoftmaxLayer(std::vector<Cvl> &CLayers, std::vector<Fcl> &hLayers, Smr &smr, std::vector<Mat> &x, Mat &y){
    //Gradient Checking (remember to disable this part after you're sure the 
    //cost function and dJ function are correct)
    getNetworkCost(x, y, CLayers, hLayers, smr);
    Mat grad;
